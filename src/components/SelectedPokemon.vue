...
const selectedProps = defineProps(['name', 'hp', 'attack', 'defense', 'specialAttack', 'specialDefense', 'speed', 'img', 'height', 'weight', 'idPoke'])
        ...
        <section
            ...
            <section class="flex flex-col justify-between w-2/4 ">
                ...
                <section class="flex justify-between items-center text-white bg-cyan-900 rounded-2xl py-2 px-4">
                    ...
                    <span class='text-xl font-semibold'>{{ selectedProps.specialAttack }}</span>
                </section>

                <section class="flex justify-between items-center text-white bg-cyan-900 rounded-2xl py-2 px-4">
                    <strong class="text-2xl">DEFESA ESPECIAL</strong>
                    <span class='text-xl font-semibold'>{{ selectedProps.specialDefense }}</span>
                </section>
